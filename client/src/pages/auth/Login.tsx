    ...
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 bg-slate-50 dark:bg-black transition-colors">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-slate-950 dark:text-white tracking-tight">Iniciar Sessão</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  placeholder="exemplo@dominio.com ou utilizador"
                  value={loginInput}
            ...
            <div className="flex items-center pt-1">
              <input
                ...
                className="w-5 h-5 rounded border-slate-300 dark:border-zinc-700 text-blue-600 focus:ring-blue-500 cursor-pointer bg-slate-50 dark:bg-zinc-900"
              />
