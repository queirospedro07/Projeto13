    ...
    <div className="p-6 rounded-3xl bg-white dark:bg-[#12141c] border border-slate-200 dark:border-[#222636] shadow-sm flex flex-col gap-4 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="px-5 py-2.5 rounded-xl font-bold text-sm bg-blue-600 hover:bg-blue-700 text-white shadow-md shadow-blue-500/20 cursor-pointer disabled:opacity-50 transition-all"
        >
