...
export const LessonResourcesTab: React.FC<LessonResourcesTabProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in">
      {resources.map((res) => (
        <div key={res.id} className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-[#12141c] border border-slate-200 dark:border-[#222636] shadow-sm">
